<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmUserWindowAdd.aspx.cs" Inherits="ExtSurat.frmUserWindowAdd" %>
...
<body>
    ...
    <div>
        ...
        <ext:FormPanel runat="server" ID="frmPanelMain" AutoHeight="true" Padding="2" DefaultAnchor="0" MonitorValid="true">
            ...
            <Items>
                <ext:TextField ID="txtUserId" runat="server" FieldLabel="ID User" AnchorHorizontal="-20" AllowBlank="false" />
                ...
                <ext:Checkbox ID="chkAktif" runat="server" FieldLabel="Aktif" AnchorHorizontal="-20" Checked="true" />
